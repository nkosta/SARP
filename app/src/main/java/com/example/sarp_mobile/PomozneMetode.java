...
public class PomozneMetode {
    ...
    /**
     * Calculates wait times for algorithm First-come, first-served (FCFS)
     *
     * @param ready_queue processes to process
     * @param a           instance of  AlgorithmsSwipeActivity which will be updated with the results
     * @throws Exception
     */
